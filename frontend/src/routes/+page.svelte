...
<div class="min-h-screen bg-slate-950 text-white">
  ...
  <!-- NAV -->
  <nav class="border-b border-white/5 bg-slate-950/80 backdrop-blur-md sticky top-0 z-50">
    <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
      ...
      <div class="flex items-center gap-3">
        ...
        <a
          href="/signup"
          class="px-4 py-2 text-sm font-semibold rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 transition-colors"
        >
          Get Started
        </a>
      </div>
  ...
  <section class="max-w-6xl mx-auto px-4 pt-24 pb-20 text-center">
    ...
    <p class="text-sm text-slate-500 max-w-xl mx-auto mb-12">
    ...
    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
      <a
        href="/signup"
        class="w-full sm:w-auto px-8 py-3.5 text-base font-semibold rounded-2xl bg-amber-500 hover:bg-amber-400 text-slate-950 transition-all shadow-lg shadow-amber-500/20 hover:shadow-amber-500/30 hover:-translate-y-0.5"
      >
        Get Started — it's free
      </a>
      <a
        href="/login"
        class="w-full sm:w-auto px-8 py-3.5 text-base font-medium rounded-2xl border border-white/10 hover:border-white/20 text-slate-300 hover:text-white bg-white/5 hover:bg-white/10 transition-all"
      >
        Sign In
      </a>
    </div>
    ...
    <div class="mt-20 relative">
      <div class="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent z-10 pointer-events-none rounded-3xl"></div>
      <div class="grid grid-cols-3 gap-3 max-w-sm mx-auto opacity-60">
        {#each ['Protein', 'Carbs', 'Fat'] as macro, i}
          <div class="rounded-2xl border border-white/5 bg-white/5 p-4 text-center">
            ...
            <div class="text-xs text-slate-500 mt-1">{macro}</div>
          </div>
        {/each}
      </div>
    </div>
  ...
  <section class="max-w-6xl mx-auto px-4 py-20">
    <div class="text-center mb-14">
      ...
      <p class="text-slate-400 text-base max-w-xl mx-auto">Built for people who want real results, not another app collecting dust.</p>
    </div>

    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <!-- AI Photo Analysis -->
      <div class="rounded-2xl border border-white/5 bg-white/5 p-6 flex flex-col gap-4">
        ...
        <div>
          <h3 class="font-semibold text-white mb-2">AI Photo Analysis</h3>
          <p class="text-sm text-slate-400 leading-relaxed">Point your camera at any meal. Our AI identifies every ingredient and estimates macros instantly.</p>
        </div>
      </div>
      ...
      <div class="rounded-2xl border border-white/5 bg-white/5 p-6 flex flex-col gap-4">
        ...
        <div>
          <h3 class="font-semibold text-white mb-2">Science-backed Macros</h3>
          <p class="text-sm text-slate-400 leading-relaxed">Targets calculated from your BMR using Mifflin-St Jeor, adjusted for activity level and goals.</p>
        </div>
      </div>
      ...
      <div class="rounded-2xl border border-white/5 bg-white/5 p-6 flex flex-col gap-4">
        ...
        <div>
          <h3 class="font-semibold text-white mb-2">Smart Health Coach</h3>
          <p class="text-sm text-slate-400 leading-relaxed">Chat with an AI coach that knows your history, tracks trends, and helps you hit your goals.</p>
        </div>
      </div>
      ...
      <div class="rounded-2xl border border-white/5 bg-white/5 p-6 flex flex-col gap-4">
        ...
        <div>
          <h3 class="font-semibold text-white mb-2">Gamification</h3>
          <p class="text-sm text-slate-400 leading-relaxed">Achievements, streaks, and confetti — staying consistent should be rewarding.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="max-w-6xl mx-auto px-4 py-20">
    <div class="text-center mb-14">
      ...
      <p class="text-slate-400 text-base max-w-xl mx-auto">No spreadsheets. No guessing. Just a clear path to your goal.</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
      ...
      {#each [
        ...
        <div class="rounded-2xl border border-white/5 bg-white/5 p-6 flex flex-col gap-4 relative">
          <div class="flex items-start gap-4">
            ...
            <span class="text-4xl font-black text-white/5 leading-none">{item.step}</span>
          </div>
      ...
      <div class="flex flex-col md:flex-row gap-8 items-start">
        ...
        <div>
          ...
          <p class="text-slate-400 leading-relaxed max-w-2xl">
            Joules calculates your TDEE using the <span class="text-white font-medium">Mifflin-St Jeor equation</span>, the gold standard validated in clinical research as the most accurate BMR formula for the general population. Combined with macronutrient targets tailored to your specific goal — cut, bulk, or maintain — you get a truly personalised plan. Not a one-size-fits-all calorie number, but protein, carb, and fat targets calibrated to how your body actually works.
          </p>
  ...
  <section class="max-w-6xl mx-auto px-4 py-16">
    <div class="rounded-2xl bg-gradient-to-br from-amber-500/20 via-amber-500/10 to-transparent border border-amber-500/20 p-10 text-center">
      ...
      <p class="text-slate-400 mb-8 max-w-md mx-auto">Join Joules today. Set up takes under two minutes.</p>
      <a
        href="/signup"
        class="inline-block px-10 py-4 text-base font-semibold rounded-2xl bg-amber-500 hover:bg-amber-400 text-slate-950 transition-all shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 hover:-translate-y-0.5"
      >
  ...
  <footer class="border-t border-white/5 mt-8">
    <div class="max-w-6xl mx-auto px-4 py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
      <div class="flex items-center gap-2.5">
        <Logo size={24} />
        <span class="text-sm text-slate-500">Joules — self-hosted nutrition tracking</span>
      </div>
