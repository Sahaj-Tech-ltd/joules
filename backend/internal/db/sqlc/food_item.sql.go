...
type DeleteFoodItemByUserParams struct {
	ID     string `json:"id"`
	UserID string `json:"user_id"`
}

func (q *Queries) DeleteFoodItemByUser(ctx context.Context, arg DeleteFoodItemByUserParams) error {
	_, err := q.db.Exec(ctx, deleteFoodItemByUser, arg.ID, arg.UserID)
	return err
}
